	 ...
	 class Main {
...

	   {
	     ...
	     //1A- generate fixed number of warehouses
		   ...
		   ArrayList<Warehouse> wareHouses =  new ArrayList<String>();
			   ...
			   
		   {
			...
			  wareHouses.add(i, new wareHouses( location[Location] , workingHours[WorkingHours] , M1 , storageCapacity =storage_Capacity ));
